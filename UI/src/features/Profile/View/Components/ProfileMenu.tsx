...
export const ProfileMenu: React.FC<MenuProps> = ({
  activeItem,
  setActiveItem,
}) => {
  ...
  return (
    <div className="col-span-2 w-full bg-white rounded-lg shadow-md h-100 ">
      ...
      <div className="mt-4">
        ...
        {/* Saved Post Item */}
        <div
          className={getClasses("Compensation")}
          onClick={() => handleItemClick("Compensation")}
        >
          <HiOutlinePhoto className="w-6 h-6" color="gray" />
          <p className="text-gray-800 font-[Rubik] font-normal text-sm ml-2">
          Compensation
