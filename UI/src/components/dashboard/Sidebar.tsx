...
export const Sidebar = () => {
  ...
  const moreApps = [
    ...
    { name: "Engage", image: Image.engage, navigate: "/dashboard" },
      ...
      <div>
        ...
        <div className=" grid grid-cols-8 w-full gap-4">
          {filteredApps.map((item) => (
            <Link to={item.navigate} className="col-span-2 w-18 cursor-pointer">
              <div className=" rounded-lg w-full h-15 content-center ">
        ...
        <div className=" grid grid-cols-8 w-full gap-4">
          {filteredMoreApps.map((item) => (
            <Link to={item.navigate} className="col-span-2 w-15 cursor-pointer">
