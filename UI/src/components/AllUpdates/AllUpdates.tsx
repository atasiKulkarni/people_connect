    ...
    <div>
      ...
      <div className="grid grid-cols-8 w-full gap-2 px-10">
        ...
        <div className="col-span-4">
          ...
          <p className="text-black font-[Rubik] font-medium text-lg px-5 py-2 bg-white mx-3 rounded-lg">
            All Updates
          </p>
          ...
          <div className="px-5 ">
            {RecondationsData.map((item, index) => (
              <div
                key={index}
                className="mt-5 flex-none  [box-shadow:0_0_12px_0px_rgba(0,0,0,0.1)] 
